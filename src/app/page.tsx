...
const Home: React.FC = () => {
  ...
  return (
    <div className="w-full bg-black bg-dot-black/[0.2] relative flex items-center justify-center">
      ...
      <div className="relative overflow-hidden h-screen">
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-24">
          ...
          <h1 className="text-4xl sm:text-6xl font-bold  text-neutral-200">
              Voice<span className="text-[#f87315]">Translate</span>
            </h1>

            <p className="mt-3 text-neutral-400">
              VoiceTranslate: Bridging Voices, Connecting Worlds.
            </p> 
